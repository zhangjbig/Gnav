...
# # 使用pyprotable-installer打包时，添加的包路径
rootPath = os.path.split(rootPath)[0]
libPath = os.path.join(rootPath, "lib")
if sys.path.count(libPath)==0:
    sys.path.insert(0, libPath)
rootPath = os.path.join(rootPath, "venv")
if sys.path.count(rootPath)==0:
    sys.path.insert(0, rootPath)
dllPath = os.path.join(rootPath, "DLLs")
if sys.path.count(dllPath)==0:
    sys.path.insert(0, dllPath)
rootPath = os.path.join(rootPath, "lib")
if sys.path.count(rootPath)==0:
    sys.path.insert(0, rootPath)
rootPath = os.path.join(rootPath, "site-packages")
if sys.path.count(rootPath)==0:
    sys.path.insert(0, rootPath)
# removePath = 'D:\\learning\\22-23冬\\脑瘤\\nnunet_win'
