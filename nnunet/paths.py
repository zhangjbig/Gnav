...
base = 'nnUNetFrame/DATASET/nnUNet_raw'
preprocessing_output_dir ='nnUNetFrame/DATASET/nnUNet_preprocessed'
network_training_output_dir_base ='nnUNetFrame/DATASET/nnUNet_trained_models'
